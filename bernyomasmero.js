...
//kezdőbér meghatározás év alapján
    if(x == 15){
        ...
        else if(vegSzint == 2){kezdoPb = 200000;}
        else if(vegSzint == 3){kezdoPb = 203000;}
        else{error = true;}
        //Minimál bér
        minBer = 177161;
...
//Szorzó meghatározása fokozat és szint alapján
    ...
    if(fokMAX){EF += "<div id='EF'><b><i>Fokozat:</i></b> Nem nőhet 1-nél többel a fokozat a 4 év alatt!</div>";}
...
//Hiba megjelenítés
    ...
    if(error == true || E15 != '' || E16 != '' || E17 != '' || E18 != '' || E19 != '' || EF != ''){
        error_box.style.display = 'block';
        error_box.innerHTML = 'HIBA<br>' + E15 + E16 + E17 + E18 + E19 + EF;
